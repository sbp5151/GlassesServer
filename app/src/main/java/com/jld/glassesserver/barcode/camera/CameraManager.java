...
package com.jld.glassesserver.barcode.camera;
...
import com.jld.glassesserver.util.DensityUtil;
...
public final class CameraManager {
    ...
    private static int MIN_FRAME_WIDTH = 453;
    private static int MIN_FRAME_HEIGHT = 453;
    private static int MAX_FRAME_WIDTH = 453;
    private static int MAX_FRAME_HEIGHT = 453;
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int width = screenResolution.x * 3 / 4;//屏幕宽度的四分之三
            ...
            int height=width;
//            int height = screenResolution.x * 3 / 4;//屏幕高度的十分之三
//            LogUtil.d(TAG, "Y：" + screenResolution.y);
//            LogUtil.d(TAG, "x:width：" + width);
//            LogUtil.d(TAG, "Y:height：" + height);
//            if (height < MIN_FRAME_HEIGHT) {
//                height = MIN_FRAME_HEIGHT;
//            } else if (height > MAX_FRAME_HEIGHT) {
//                height = MAX_FRAME_HEIGHT;
//            }
            int leftOffset = (screenResolution.x - width) / 2;//和屏幕边缘距离
//            int topOffset = (screenResolution.y - height) / 2;
//            framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
//                    topOffset + height);
//            framingRect = new Rect(leftOffset, 137 + 216, leftOffset + width,
//                    height + 216 + 137);
            ...
            int dp_width = DensityUtil.dip2px(context, widthPixels);
            int dp_height = DensityUtil.dip2px(context, heightPixels);
//            framingRect = new Rect(leftOffset,topOffset,leftOffset + width, topOffset + height);
            framingRect = new Rect(26,26,widthPixels-52,  heightPixels-52);
